...
import it.me.gameoflife.gui.GUImatrix;
import it.me.gameoflife.gui.GUImenu;
import it.me.gameoflife.gui.GUIoptions;
import it.me.gameoflife.gui.GUIpatterns;
import it.me.gameoflife.main.Main;
import it.me.gameoflife.matrix.PatternsLibrary;
...
public class InputHandler implements MouseListener {
	...
	public static GUImatrix matrix_gui;
	public static GUIoptions options;
	static GUIpatterns patterns_gui = new GUIpatterns();

	public static Square[][] squares = new Square[100][100];

	public InputHandler(String p_type) {
	...
	public void mouseClicked(MouseEvent e) {
		...
		if (type.equals("menu gui")) {
			...
			if (squares[row][column].isAlive)
				squares[row][column].isAlive = false;
			else
				squares[row][column].isAlive = true;
	...
	public void addListener(JButton c) {
